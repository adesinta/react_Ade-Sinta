...
const Form = () => {
  ...
  const handleEdit = (productId) => {
    ...
    setProductCategory(productToEdit.productCategory[0]);
    setProductImage(null);
    setProductFreshness(productToEdit.productFreshness[0]);
    setProductPrice(productToEdit.productPrice);
    setAdditionalDescription(productToEdit.additionalDescription);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    reader.onloadend = async () => {
      const updatedProduct = {
        ...
        productImage: reader.result ? reader.result : editingProduct.productImage,
      ...
      try {
        if (editingProduct) {
          const response = await axios.put(
            `https://651eae1344a3a8aa4768cdc2.mockapi.io/products/${editingProduct.id}`,
            updatedProduct
          );
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(
        `https://651eae1344a3a8aa4768cdc2.mockapi.io/products/${productToDelete}`
      );
