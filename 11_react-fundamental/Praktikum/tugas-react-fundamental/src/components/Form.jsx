  ...
  return (
    <div>
      <div className="mt-14 flex flex-col items-center gap-1">
        ...
        <div className="pt-4">
          <label htmlFor="productCategory" className="pr-[370px]">
            Product Category
          </label>
          <select
            id="countries"
        ...
        <div className="pt-4">
          <label htmlFor="imageOfProduct" className="pr-[370px]">
            Image Of Product
          </label>
        ...
        <div>
          <label htmlFor="additionalDesc" className="pr-[340px]">
        ...
        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-6 mt-4 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-[500px]">Submit</button>
      </div>
    </div>
  );
};
